...
const routes = [
  {
    ...
    openapi: {
      responses: {
        200: { description: "Service healthy", content: { "application/json": { schema: healthResponseSchema } } },
      },
    },
  },
  {
    ...
    openapi: {
      ...
      responses: {
        200: { description: "Metrics fetched successfully", content: { "application/json": { schema: metricsResponseSchema } } },
      },
