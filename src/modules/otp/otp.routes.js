...
const routes = [
  {
    ...
    openapi: {
      request: {
        headers: appHeadersSchema,
        body: { content: { 'application/json': { schema: otpSendRequestSchema } } },
      },
      responses: {
        200: {
          description: 'OTP sent successfully',
          content: { 'application/json': { schema: otpSendSuccessSchema } },
        },
        429: {
  ...
  },
  {
    ...
    openapi: {
      request: {
        headers: appHeadersSchema,
        body: { content: { 'application/json': { schema: otpVerifyRequestSchema } } },
      },
      responses: {
        200: {
          description: 'OTP verified successfully',
          content: { 'application/json': { schema: otpVerifySuccessSchema } },
        },
        422: {
  ...
  },
  {
    ...
    openapi: {
      request: {
        headers: appHeadersSchema,
        body: { content: { 'application/json': { schema: otpResendRequestSchema } } },
      },
      responses: {
        200: {
          description: 'OTP resent successfully',
          content: { 'application/json': { schema: otpResendSuccessSchema } },
        },
        429: {
          description: 'Resend OTP error',
          content: { 'application/json': { schema: errorEnvelopeSchema } },
        },
      },
      security: [{ appHeaders: [] }],
