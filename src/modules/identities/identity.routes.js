...
const routes = [
  ...
  },
  {
    ...
    middlewares: [
      validate({ headers: appUserHeadersSchema, body: verifyContactRequestSchema }),
      appAuth,
      userAuth,
    ],
    ...
    openapi: {
      request: {
        headers: appUserHeadersSchema,
        body: { content: { 'application/json': { schema: verifyContactRequestSchema } } },
      },
      responses: {
        200: {
