...
const { createAppRequestSchema, updateAppRequestSchema, updateAppConfigRequestSchema, createAppSuccessSchema, appSuccessSchema } = require("../../schemas/apps");
...
const routes = [
  {
    ...
    middlewares: [validate({ headers: adminHeadersSchema, body: createAppRequestSchema }), adminAuth],
    ...
    openapi: {
      ...
      responses: {
        201: { description: "App created successfully", content: { "application/json": { schema: createAppSuccessSchema } } },
  ...
  },
  {
    ...
    middlewares: [validate({ headers: adminHeadersSchema, params: z.object({ appId: z.string().min(1) }) }), adminAuth],
    handler: appController.getApp.bind(appController),
    openapi: {
      request: { headers: adminHeadersSchema, params: z.object({ appId: z.string().min(1) }) },
      responses: {
        200: { description: "App fetched successfully", content: { "application/json": { schema: appSuccessSchema } } },
      },
      security: [{ internalAdminKey: [] }],
    },
  },
  {
    ...
    middlewares: [validate({ headers: adminHeadersSchema, params: z.object({ appId: z.string().min(1) }), body: updateAppRequestSchema }), adminAuth],
    ...
    openapi: {
      ...
      responses: {
        200: { description: "App updated successfully", content: { "application/json": { schema: appSuccessSchema } } },
      },
      security: [{ internalAdminKey: [] }],
    },
  },
  {
    ...
    middlewares: [validate({ headers: adminHeadersSchema, params: z.object({ appId: z.string().min(1) }), body: updateAppConfigRequestSchema }), adminAuth],
    ...
    openapi: {
      ...
      responses: {
        200: { description: "App config updated successfully", content: { "application/json": { schema: appSuccessSchema } } },
      },
      security: [{ internalAdminKey: [] }],
    },
  },
